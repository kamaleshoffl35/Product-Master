        ...
        <div className="container mt-4 bg-gradient-warning">
            ...
            <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-md-4 form-check">
                    <input type="checkbox" className="form-check-input bg-light" name="is_batch_tracked" checked={form.is_batch_tracked} onChange={handleChange}  />
                    <label className="form-check-label ">Batch Tracking</label>
                </div>
                <div className="col-md-4 form-check">
                    <input type="checkbox" className="form-check-input bg-light" name="is_serial_tracked" checked={form.is_serial_tracked} onChange={handleChange}/>
